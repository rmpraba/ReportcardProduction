...
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') "+
"and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and "+
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and subject_id='"+req.query.subjectid+"' order by student_name";
}
else{
var qur="select school_id,id,student_name,class_id  from md_student where  class_id="+
"(select class_id  from mp_grade_section where grade_id=(select grade_id "+
...
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') "+
"and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and "+
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' order by student_name";
}
 console.log('--------------------------enrichment stud fetch------------------------------');
 console.log('--------------------------------------------------------');
 console.log(qur);
...
"school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and id not in(select student_id from tr_term_health where   term_id='"+req.query.termname+"' and grade='"+req.query.gradename+"' and  section='"+req.query.section+"' and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"')";
 connection.query(qur,
    function(err, rows)
    {
    if(!err)
...
{   
  ...
  "(select grade_id from mp_grade_section where class_id="+
  "(select class_id from md_student where id='"+req.query.studid+"' "+
  "and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') order by subject_category";
...
"(select count(*) from tr_student_to_subject where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and class_id=(select class_id from mp_grade_section where grade_id=(select grade_id "+
"from md_grade where grade_name='"+req.query.gradename+"') and section_id=(select "+
...
"where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and grade='"+req.query.gradename+"' and section='"+req.query.sectionname+"' "+
"and subject_id='"+req.query.subject+"' and term_name='"+req.query.termname+"' and assesment_id='"+req.query.assesmentid+"') AS count1, "+
"(select count(*) from md_student where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and class_id=(select class_id from mp_grade_section where grade_id=(select grade_id "+
"from md_grade where grade_name='"+req.query.gradename+"') and section_id=(select "+
...
"where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and grade='"+req.query.gradename+"' and section='"+req.query.sectionname+"' "+
"and subject_id='"+req.query.subject+"' and term_name='"+req.query.termname+"' and category='"+req.query.assesmentid+"') AS count1, "+
"(select count(*) from tr_student_to_subject where academic_year='"+req.query.academicyear+"' and school_id='"+req.query.schoolid+"' and class_id=(select class_id from mp_grade_section where grade_id=(select grade_id "+
"from md_grade where grade_name='"+req.query.gradename+"') and section_id=(select "+
...
var qur1="select *,(select subject_category from md_subject where subject_name=subject) as category from tr_term_assesment_import_marks where flag='"+req.query.flag+"' and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' "+
...
"(select count(*) from md_student where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.acadamicyear+"' and class_id=(select class_id from mp_grade_section where grade_id=(select grade_id "+
"from md_grade where grade_name='"+req.query.gradename+"') and section_id=(select "+
...
app.post('/fetchstudentforissue-service',  urlencodedParser,function (req,res)
  {  
    var qur="SELECT * FROM md_student WHERE class_id in(SELECT class_id FROM mp_grade_section WHERE grade_id='"+req.query.gradeid+"' and section_id='"+req.query.sectionid+"' and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"') and school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"'";
...
app.post('/assignbooktostudent-service',  urlencodedParser,function (req,res)
  {  
    ...
    var qur="INSERT INTO enrichment_bookissuance_details SET ?";
    console.log('------------insert book info for stud-------------');
    console.log(qur);
    connection.query(qur,[response],
    function(err, rows)
    {
...
app.post('/subjectscholasticapproval-service',  urlencodedParser,function (req,res)
  { 
   var data={
    ...
    if(req.query.flag=='0')
    var checkqur="SELECT * FROM tr_term_assesment_import_marks WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade='"+req.query.gradename+"' and section='"+req.query.section+"' and subject='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and flag in('0','1')";
    else
    var checkqur="SELECT * FROM tr_term_assesment_import_marks WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade='"+req.query.gradename+"' and section='"+req.query.section+"' and subject='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and flag in('1')";
    ...
    if(req.query.flag=="1")
    var qur="update tr_term_assesment_import_marks set ? WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
...
app.post('/subjectapproval-service',  urlencodedParser,function (req,res)
  { 
   var data={
    ...
    if(req.query.flag=='0')
    var checkqur="SELECT * FROM tr_term_fa_assesment_import_marks WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade='"+req.query.gradename+"' and section='"+req.query.section+"' and subject='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and flag in('0','1')";
    else
    var checkqur="SELECT * FROM tr_term_fa_assesment_import_marks WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade='"+req.query.gradename+"' and section='"+req.query.section+"' and subject='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and flag in('1')";
    ...
    if(req.query.flag=="1")
    var qur="update tr_term_fa_assesment_import_marks set ? WHERE school_id='"+req.query.schoolid+"' and academic_year='"+req.query.academicyear+"' and "+
    " grade='"+req.query.gradename+"' and section='"+req.query.section+"' and subject='"+req.query.subject+"' and assesment_id='"+req.query.assesment+"' and flag='0'";
...
app.post('/enrichmentexcel-service',  urlencodedParser,function (req,res)
  {
  var qur="select *,(select id from md_student where school_id='"+req.query.schoolid+"' and academic_year='"+req.query.adacademicyear+"' and "+
...
app.post('/fngetconceptvalue111-service',  urlencodedParser,function (req,res)
  {  
      ...
      var qur2="SELECT * FROM md_book_value where  capter_id='"+req.query.capter_id+"' and  planning_date='"+req.query.planneddate+"' and period='"+req.query.period+"'";
   console.log(qur1);
    console.log(qur2);
    var conceptarr=[];
    var skillarr=[];
...
{  
  var qur="SELECT grade,term_name,subject_id,assesment_id,student_id,sum(mark) as total FROM tr_term_fa_assesment_marks WHERE school_id='"+req.query.schoolid+"' AND academic_year='"+req.query.academicyear+"' AND student_id='"+req.query.studentid+"' group by term_name,assesment_id,subject_id,student_id,grade order by subject_id";
  var scalequr="SELECT * FROM scaledown_master WHERE academic_year='"+req.query.academicyear+"' AND term_name='"+req.query.termname+"'";
...
{  
  ...
  var subqur="SELECT distinct(subject_id) FROM tr_term_fa_assesment_marks WHERE school_id='"+req.query.schoolid+"' AND academic_year='"+req.query.academicyear+"' and student_id='"+req.query.studentid+"' order by subject_id";
  var gradequr="SELECT * FROM newformat_scholastic_grademaster";
  var scaleup="SELECT sum(actual_scale) as tot,subject_name,grade_name FROM scaledown_master group by subject_name,grade_name order by subject_id"
  console.log('----------------------------------------');
  console.log(qur);
  console.log('----------------------------------------');
  console.log(scalequr);
...
{  
  ...
  "AND academic_year='"+req.query.academicyear+"' AND student_id='"+req.query.studentid+"' "+
  "group by subject_id";
...
var mapqur="SELECT * FROM subject_mapping WHERE  academic_year='"+req.query.academicyear+"' and "+
...
" academic_year='"+req.query.academicyear+"' and assesment_id='"+req.query.assesmenttype+"' and term_name='"+req.query.termname+"' and "+
" grade='"+req.query.grade+"' and section='"+req.query.section+"' and subject_id='"+req.query.subject+"' order by student_name,category";
var mapqur="SELECT distinct(category_name),category_id FROM subject_mapping WHERE  academic_year='"+req.query.academicyear+"' and "+
